...
var (
	oldDesertGVK = schema.GroupVersionKind{
		Group:   dwsv1alpha.GroupVersion.Group,
		Version: "v1old",
		Kind:    "Desert",
	}
)
...
func TestMarshalData(t *testing.T) {
	...
	t.Run("should write source object to destination", func(t *testing.T) {
		...
		dst.SetGroupVersionKind(oldDesertGVK)
		dst.SetName("test-1")
		...
		g.Expect(dst.GetAnnotations()[DataAnnotation]).To(ContainSubstring("Arriving"))
		g.Expect(dst.GetAnnotations()[DataAnnotation]).To(ContainSubstring("Coastal"))
		g.Expect(dst.GetAnnotations()[DataAnnotation]).To(ContainSubstring("mumble"))
	...
	t.Run("should append the annotation", func(t *testing.T) {
		...
		dst := &unstructured.Unstructured{}
		dst.SetGroupVersionKind(dwsv1alpha.GroupVersion.WithKind("Desert"))
		dst.SetName("test-1")
